export const features = [
  {
    ...
    text: "With the Nordic Wellness app, managing your fitness journey has never been easier. Smart features and seamless automation help you book classes, track workouts, and stay motivated—like having a personal trainer in your pocket.",
    button: {
  ...
  },
  {
    ...
    caption: "Easy & convenient",
    title: "Sleep easy, we got your back",
    text: "With the Nordic Wellness app, staying on top of your fitness has never been easier. Effortless navigation and smart features let you book classes, track progress, and stay motivated—like having a workout buddy, but without the hassle.",
    button: {
...
export const details = [
  {
    ...
    title: "Easy and manageable",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Collaborate with a PT",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Reform and improve your progress",
  },
  {
    id: "3",
...
export const faq = [
  {
    id: "0",
    question: "How easy is it to setup Nordic wellness app?",
    answer:
"It's as easy as going to your respective app store, searching for Nordic Wellness, and it should pop up."  },
  {
    id: "1",
    question: "Can I integrate Nordic Wellness with other platforms?",
    answer:
      "Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.",
  },
  {
    id: "2",
    question: "How often do you need check your app?",
    answer:
"Absolutely! Not only can you upgrade your plan at any time, but you also receive a prorated discount, and rewards ensuring you get the maximum value from your subscription."  },
  {
    id: "3",
    question: "What your refund policy?",
    answer:
"Absolutely! You can upgrade your plan at any time and receive a prorated discount, but please note that refunds are not available."  },
  {
    id: "4",
    question: "Do you have other plans than listed?",
    answer:
"Absolutely! You can upgrade your plan at any time with a prorated discount, but upgrades are only available once and on a weekly basis. No other plans are available beyond the ones already shown."  },
  {
    id: "5",
    question: "What happens when I’m forgot to renew my membership?",
    answer:
      "No worries, you can always go to your local location and renew their on their opening times.",
  },
  {
    id: "6",
  ...
  {
    id: "7",
    question: "How do I invite my training partner?",
    answer:
      "Ask for a free week of training to your training partner.",
  },
  {
    id: "8",
    question: "Do you offer other form of payments, like cash?",
    answer:
      "No, only cards are allowed as form of payments.",
  },
  {
    id: "9",
    question: "I’m locked out of my account what do I do?",
    answer:
      "Call our support to help you with that, otherwise log ut, and log in again to fix that problem.",
  },
];
...
export const plans = [
  {
    id: "0",
    title: "Student/Pensioner",
    priceMonthly: 40,
    priceYearly: 30,
    caption: "Best for those students and pensioners",
    features: [
      "Needs mecenat/pension discount",
      "Avaliable to train everywhere",
      "PT time included",
      "Grand Fitness not included",
    ],
  ...
  },
  {
    ...
    priceMonthly: 70,
    priceYearly: 59,
    caption: "Most expensive plan",
    features: [
      "All gyms included",
      "Avaliable to train everywhere",
      "PT time included + necessities",
      "Grand Fitness not included",
    ],
  ...
  },
  {
    ...
    priceMonthly: 65,
    priceYearly: 50,
    caption: "Regular plan for those training regularly",
    features: [
      "Works only for your own city",
...
export const testimonials = [
  {
    ...
    comment:
      "Nordic wellness customer support is second to none! They’re like my superheroes, always there when I need them.",
  },
  {
    id: "1",
    name: "Mark Ericsson",
    ...
    comment:
      "I was skeptical at first, but now I can't imagine my training without them. It's that impactful.",
  },
  {
    id: "2",
    name: "Melanie Hurst",
    ...
    comment:
      "Adopting this training lifestyle was a breeze. It's made everyday training sessions so much simpler.",
  },
  {
    id: "3",
    name: "Alicia Svenson",
    ...
    comment:
      "The Triggz feature is like having an enganging way to keep going. It's been instrumental in my training journey.",
  },
  {
    id: "4",
    name: "Becky Snider",
    ...
    comment:
      "Switched to Nordic Wellness last month, and I'm already seeing results. Best decision for me!",
  },
  {
    id: "5",
    name: "Jimmy Bradley",
    ...
    comment:
      "The efficiency of triggz is undeniable. This platform has transformed my training to another level.",
  },
];
...
export const logos = [
  {
    id: "0",
    title: "KLARNA",
    url: "/images/logos/Klarna-Logo.wine_.png",
    width: 170,
    height: 58,
  },
  {
    id: "1",
    title: "BankId",
    url: "/images/logos/bankidlogo.png",
    width: 100,
    height: 48,
  },
  {
    id: "2",
    title: "Sonos",
    url: "/images/logos/paypal_PNG9.png",
    width: 120,
    height: 48,
  },
  {
    id: "3",
    title: "Maze",
    url: "/images/logos/Swish-Logo-Secondary-Light-BG.png",
    width: 130,
    height: 43,
  },
  {
    id: "4",
    title: "Drips",
    url: "/images/logos/VisaMasterCard.webp",
    width: 150,
    height: 48,
  },
];
